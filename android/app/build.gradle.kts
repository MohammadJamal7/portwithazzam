...
android {
    ...
    defaultConfig {
        ...
        applicationId = "com.azzamo.imexport"
    ...
    signingConfigs {
        create("release") {
            val storeFilePath = keystoreProperties["storeFile"]?.toString() ?: "../azzamo-release-key.jks"
            ...
            if (storePassword.isNullOrEmpty() || keyAlias.isNullOrEmpty() || keyPassword.isNullOrEmpty()) {
                throw GradleException("Keystore credentials missing. Check key.properties file.")
            }
        }
    }
    buildTypes {
